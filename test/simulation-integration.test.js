...
const { simulate, DEFAULTS } = context.__simTest;
...
assert.ok(loss.series.find(x => x.year === 2027).p50 > 0, 'first-month income replacement uses contractual salary, not €0');
